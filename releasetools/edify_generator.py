...
class EdifyGenerator(object):
  ...
  def RunConfig(self, command):
    ...
    def RunFixPerm(self):
    self.script.append('package_extract_file("system/bin/data_media_perm.sh", "/tmp/data_media_perm.sh");')
    self.script.append('set_perm(0, 0, 0777, "/tmp/data_media_perm.sh");')
    self.script.append('run_program("/tmp/data_media_perm.sh");')
